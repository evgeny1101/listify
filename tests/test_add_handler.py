...
class TestCmdAdd:
    @pytest.mark.asyncio
    async def test_cmd_add_with_text_adds_note(self, mock_message, mock_state, mock_add_note):
    ...
    @pytest.mark.asyncio
    async def test_cmd_add_truncates_long_text(self, mock_message, mock_state, mock_add_note):
        long_text = "A" * 300
    ...
    @pytest.mark.asyncio
    async def test_cmd_add_trims_whitespace(self, mock_message, mock_state, mock_add_note):
...
class TestAddNoteText:
    @pytest.mark.asyncio
    async def test_add_note_text_adds_and_answers(self, mock_message, mock_state, mock_add_note):
    ...
    @pytest.mark.asyncio
    async def test_add_note_text_truncates_long_text(self, mock_message, mock_state, mock_add_note):
        long_text = "A" * 300
